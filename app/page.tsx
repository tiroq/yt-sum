...
type Health = { status: string; queue_paused: boolean; library: string; queues?: { download: QueueHealth; llm: QueueHealth }; components: Record<string, { ready: boolean; version?: string; engine?: string; address?: string; state?: string; reason?: string }> };
